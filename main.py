...
from .database import (Article, Tag, create_article)
...
def about():
    ...
    return render_template('page.html',title='About',content=content)


@app.route('/links')
def links():
    content = load_content('links')
    return render_template('page.html',title='Links',content=content)
...
def show_article(id):
    ...
    return render_template('page.html',title=article.title,content=article.content,pub_time=article.pub_time,tags=article.tags)
